...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border transition-colors hover:bg-surface-hover/40 data-[state=selected]:bg-surface-hover",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle text-xs font-medium text-text-secondary [&:has([role=checkbox])]:pr-0",
      className,
    )}
    {...props}
  />
